...
renderSection = () => {
  ...
  render() {
    return (
      ...
      <ScrollView  horizontal={true} style={{padding:8}}  showsVerticalScrollIndicator={false} showsHorizontalScrollIndicator={false} >
        <Button 
        style={{padding:15}}
         onPress={() => this.segmentClicked(0)}
         active={this.state.activeIndex == 0}
        transparent>
        <Image source={{uri: 'https://reactnative.dev/img/tiny_logo.png'}} style={{height:width/45*5,width:width/45*5,borderRadius:50 }}>
      ...
      <Text style={{fontWeight:"bold",paddingLeft:20}}>Shopimm</Text>
      <Text style={{fontWeight:"bold",paddingLeft:20}}>Shopimm</Text>
      <Text style={{fontWeight:"bold",paddingLeft:20}}>Shopimm</Text>
      <Text style={{fontWeight:"bold",paddingLeft:30}}>Shopimm</Text>
      <Text style={{fontWeight:"bold",paddingLeft:10}}>Shopimm</Text>
